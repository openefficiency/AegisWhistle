        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 text-lg mb-8">
                Transform your business with cutting-edge AI technology that delivers unprecedented results and user experience.
              </p>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">Trusted by forward-thinking businesses worldwide</span>
              </div>
            </div>
            ...
            <div className="bg-purple-600/20 backdrop-blur-xl border border-purple-500/30 rounded-2xl p-6 hover:border-purple-400/50 transition-all duration-300 shadow-2xl">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-green-400 text-sm bg-green-400/20 px-3 py-1 rounded-full animate-pulse">Live</span>
              </div>
              ...
              <div className="py-8">
                ...
                <p className="text-white text-lg text-center">Processing data with 98.5% accuracy</p>
                <p className="text-gray-400 text-sm text-center mt-2 flex items-center justify-center space-x-1">
                  <span>AI is actively listening and analyzing...</span>
          ...
          <div className="mt-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-black/30 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-6 text-center hover:border-purple-400/40 transition-all duration-300 hover:scale-105 shadow-xl">
                ...
                <h4 className="text-white font-bold mb-2">Military-Grade Anonymity</h4>
                <p className="text-gray-300 text-sm">Tor networks + zero-knowledge proofs</p>
              </div>
              
              <div className="bg-black/30 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-6 text-center hover:border-purple-400/40 transition-all duration-300 hover:scale-105 shadow-xl">
                <TrendingUp className="w-12 h-12 text-green-400 mx-auto mb-4" />
                <h4 className="text-white font-bold mb-2">AI-Driven Case Triage</h4>
                <p className="text-gray-300 text-sm">94% fraud detection accuracy</p>
              </div>
              
              <div className="bg-black/30 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-6 text-center hover:border-purple-400/40 transition-all duration-300 hover:scale-105 shadow-xl">
                <Link className="w-12 h-12 text-pink-400 mx-auto mb-4" />
                <h4 className="text-white font-bold mb-2">Blockchain-Sealed Evidence</h4>
                <p className="text-gray-300 text-sm">Tamper-proof Hyperledger + IPFS</p>
              </div>
              
              <div className="bg-black/30 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-6 text-center hover:border-purple-400/40 transition-all duration-300 hover:scale-105 shadow-xl">
                <Coins className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
                <h4 className="text-white font-bold mb-2">Untraceable Crypto Rewards</h4>
                <p className="text-gray-300 text-sm">Crypto payouts post-investigation</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center border-t border-white/10 pt-12">
            <p className="text-gray-300 text-lg mb-2 flex items-center justify-center space-x-2">
              <span>AI that actually listens and understands your employees.</span>
              <span className="text-xl">🎙️</span>
            </p>
            <p className="text-gray-400 text-sm">
              Processing audio with 99.7% accuracy
            </p>
          </div>
        </div>
